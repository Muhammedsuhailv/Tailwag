...
import 'package:mainproject/views/admin/pharmacy/adminpharmacy.dart';
import 'package:mainproject/views/admin/product/admin_product.dart';
import 'package:mainproject/views/admin/shops/adminshops.dart';
