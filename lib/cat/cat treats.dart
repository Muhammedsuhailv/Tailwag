...
class cattreats extends StatefulWidget {
  const cattreats({Key? key}) : super(key: key);
                        ...
                        InkWell(
                            ...
                            child: CircleAvatar(
                                ...
                                child: CircleAvatar(
                                    ...
                                    backgroundImage:
                                        AssetImage("img/cat biscuits.jpeg")))),
                        Text(
                          "Biscuits\nTreats",
                    ...
                    Column(children: [
                      CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 30,
                            backgroundColor: HexColor("86AF9F"),
                            backgroundImage: AssetImage("img/cream.jpg"),
                          )),
                      Text(
                        "Creamy\nTreats",
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ...
                      children: [
                        CircleAvatar(
                            ...
                            child: CircleAvatar(
                              radius: 30,
                              backgroundColor: HexColor("86AF9F"),
                              backgroundImage: AssetImage("img/jerky.jpg"),
                            )),
                        Text(
                          "Jerky\nTreats",
                          style: TextStyle(fontWeight: FontWeight.bold),
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: AssetImage("img/catnulo3.jpeg")))),
                        Text(
                          "Nulo",
                          style: TextStyle(
                              color: HexColor("7A5600"),
                      ...
                      Card(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: HexColor("AF924E")),
                            child: Image.asset(
                                "img/nulo_cat_fd-removebg-preview.png"),
                          )),
                      Card(
                          elevation: 5,
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: HexColor("AF924E")),
                            child: Image.asset(
                                "img/drools_cat-removebg-preview.png"),
                          )),
                      Card(
                          elevation: 5,
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: HexColor("AF924E")),
                            child: Image.asset(
                                "img/pure_cat_fd-removebg-preview.png"),
                          )),
                    ],
                  ),
                ),
