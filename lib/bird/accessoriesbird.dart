...
import 'package:mainproject/bird/birdaccessorieslist.dart';
import 'package:mainproject/bird/birdhealthlist.dart';
import 'package:mainproject/cat/cathealthlist.dart';
...
class birdacssories extends StatefulWidget {
  const birdacssories({Key? key}) : super(key: key);

  @override
  State<birdacssories> createState() => _birdacssoriesState();
}

class _birdacssoriesState extends State<birdacssories> {
          ...
          child: Column(children: [
            ...
            SizedBox(height: 1226,width: 999,
              child: GridView.builder(
                  itemCount: birdacs.length,controller: new ScrollController(keepScrollOffset: false,),
                ...
                return Padding(
                  ...
                  Stack(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(width: 165,
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(  birdacs[index]['txt'],style: TextStyle(color: HexColor("604401"),fontWeight: FontWeight.bold),),
                              Text(birdacs[index]['sub']),
                              Row(
                                children: [
                                  Text("MRP :",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,)),
                                  Text(birdacs[index]['reg'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,decoration: TextDecoration.lineThrough),),
                                  Text(birdacs[index]['pri'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900),),
                      ...
                      Positioned(child: Card(elevation: 5,child: Container(height: 138,width: 165,decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color:  HexColor("F2DFB2"),image: DecorationImage(fit: BoxFit.cover,image:birdacs[index]['image']))))),
            ...
            // SizedBox(height: 596,width: 999,
            //   child: GridView.builder(
            //       itemCount: birdhealthi.length,controller: new ScrollController(keepScrollOffset: false,),
            //       gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,childAspectRatio: 0.6,crossAxisSpacing: 0.0 ,mainAxisSpacing: 14),itemBuilder: (context,index){
            //     return Padding(
            //       padding: const EdgeInsets.only(left: 4,right: 4),
            //       child: Stack(
            ...
            //               image:DecorationImage(fit: BoxFit.cover,image:birdhealthi[index]['image']),
            //             ),
            //           ),
            //
            //           Positioned(top: 145,
            ...
            //                           child: Text(   birdhealthi[index]['txt'],style: TextStyle(color: HexColor("7A5600"),fontWeight: FontWeight.bold),),
            //                         ),
            //                         // SizedBox(height: 5,),
            //
            ...
            //                             Text(birdhealthi[index]['rat'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900),),
            //                             Text(birdhealthi[index]['rew'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w400),),
            //                           ],
            //                         ),
            //                         Padding(
            //                           padding: const EdgeInsets.only(left: 8.0),
            ...
            //                             children: [
            //                               Text("MRP :",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,)),
            //                               Text(birdhealthi[index]['reg'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,decoration: TextDecoration.lineThrough),),
            //                               Text(birdhealthi[index]['pri'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900),),
            //
            //                             ],
            //                           ),
            //                         ),
            ...
            //                           child: Text(birdhealthi[index]['off'],style: TextStyle(color: Colors.grey[700],fontWeight: FontWeight.w700),),
            //                         ),
            //                       ]),
            //                 ),
            //
