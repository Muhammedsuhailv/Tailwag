...
class birdhealth extends StatefulWidget {
  const birdhealth({Key? key}) : super(key: key);

  @override

  State<birdhealth> createState() => _birdhealthState();
}

class _birdhealthState extends State<birdhealth> {
                ...
                return Padding(
                  ...
                  Stack(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(width: 165,
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(  birdhealthi[index]['txt'],style: TextStyle(color: HexColor("604401"),fontWeight: FontWeight.bold),),
                              Text(birdhealthi[index]['sub']),
                              Row(
                                children: [
                      ...
                      Positioned(child: Card(elevation: 5,child: Container(height: 138,width: 165,decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color:  HexColor("F2DFB2"),image: DecorationImage(fit: BoxFit.cover,image:birdhealthi[index]['image']))))),
