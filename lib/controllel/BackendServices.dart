...
class BackendServiecs {
  ...
  ///////////////////////////////////////////////////PET DETAILS//////////////////////////////////////////////////////////
  Future<void> petDetails(String petname, String breedname, String petsex, String petage,
      String petkg, String aboutmypet, context) async {
    try {
  ...
  Future<void> createData(
    ...
    try {
      ...
      _myNotesModel = MyNotesModel(
          noteid: recordDoc.id, date: date, description: description, hospital:hospital);
