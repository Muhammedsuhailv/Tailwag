...
import 'package:mainproject/fish/healthlist.dart';
          ...
          child: Column(children: [
            ...
            SizedBox(height: 1559,width: 999,
              child: GridView.builder(
                  itemCount: fishhealthh.length,controller: new ScrollController(keepScrollOffset: false,),
                ...
                return Padding(
                  ...
                  Stack(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(width: 165,
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(  fishhealthh[index]['txt'],style: TextStyle(color: HexColor("604401"),fontWeight: FontWeight.bold),),
                              Text(fishhealthh[index]['sub']),
                              Row(
                                children: [
                                  Text("MRP :",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,)),
                                  Text(fishhealthh[index]['reg'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,decoration: TextDecoration.lineThrough),),
                                  Text(fishhealthh[index]['pri'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900),),
                      ...
                      Positioned(child: Card(elevation: 5,child: Container(height: 138,width: 165,decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color:  HexColor("F2DFB2"),image: DecorationImage(fit: BoxFit.cover,image:fishhealthh[index]['image']))))),
