...
import 'package:mainproject/fish/fishacssorislist.dart';
...
class fishaccessories extends StatefulWidget {
  const fishaccessories({Key? key}) : super(key: key);

  @override
  State<fishaccessories> createState() => _fishaccessoriesState();
}

class _fishaccessoriesState extends State<fishaccessories> {
                ...
                return Padding(
                  ...
                  Stack(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(width: 165,
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(  fishacs[index]['txt'],style: TextStyle(color: HexColor("604401"),fontWeight: FontWeight.bold),),
                              Text(fishacs[index]['sub']),
                              Row(
                                children: [
                                  Text("MRP :",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,)),
                                  Text(fishacs[index]['reg'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,decoration: TextDecoration.lineThrough),),
                                  Text(fishacs[index]['pri'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900),),
                      ...
                      Positioned(child: Card(elevation: 5,child: Container(height: 128,width: 165,decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color:  HexColor("F2DFB2"),image: DecorationImage(fit: BoxFit.cover,image:fishacs[index]['img']))))),
