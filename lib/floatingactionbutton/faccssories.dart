...
import 'package:mainproject/floatingactionbutton/accssoriesdetailpage.dart';
import 'package:mainproject/floatingactionbutton/faccssorieslist.dart';
...
import 'package:mainproject/floatingactionbutton/helthlist.dart';
class facss extends StatefulWidget {
  const facss({Key? key}) : super(key: key);

  @override
  State<facss> createState() => _facssState();
}

class _facssState extends State<facss> {
        ...
        body:Container(height: double.infinity,width: double.infinity,color:HexColor("F2DFB2"),child: SingleChildScrollView(
          child: Column(children: [
            ...
            SizedBox(height: 4300,
              child: GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,childAspectRatio: 0.7,crossAxisSpacing: 0.0 ,mainAxisSpacing: 13),physics: NeverScrollableScrollPhysics(),itemCount:facs.length, itemBuilder: (context,index){
                return      Column(
                        ...
                        Padding(
                          ...
                          child: InkWell(onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => AccssoriesDetailPage(
                                  img: facs[index]['img'] ?? AssetImage('placeholder_image_path'),  // Provide a placeholder image if 'img' is null
                                  text: facs[index]['txt'],
                              ...
                              // sub:foodi[index]['sub'],pri:foodi[index]['pri'], per: foodi[index]['per'], bra: foodi[index]['bra'], fla: foodi[index]['fla'],
                            //
...
//                                   Text(facs[index]['txt'] ,style: TextStyle(fontWeight: FontWeight.bold,color: HexColor("7A5600") ),),
//                                   Text(facs[index]['sub'] ,style: TextStyle( ),),
//                                   Row(children: [
//                                     Text("MRP:"),
//                                     Text(facs[index]['pri'] ,style: TextStyle(fontWeight: FontWeight.bold),),
//                                     Text(facs[index]['%'] ,style: TextStyle(fontWeight: FontWeight.bold,color: HexColor("E19B47")),),
//
//
//                                   ]),
//                                 ],
...
//                             ),
// //
//                             Card(elevation: 3,child: Container(height: 100,width:300,decoration: BoxDecoration(color:HexColor("F2DFB2"),image:DecorationImage(image: facs[index]['img']) ),))
//
//                           ]),
//
//
